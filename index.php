				...
				<div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
							    <img class="img-responsive img-full" src="img/team.gif" alt="">
							</div>
                            <div class="item">
							    <img class="img-responsive img-full" src="img/busking.gif" alt="">
							</div>
                            <div class="item">
							    <img class="img-responsive img-full" src="img/exhibitionLaunch.gif" alt="">
							</div>
                        </div>
